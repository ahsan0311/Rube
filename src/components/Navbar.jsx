...
export default function Navbar() {
  ...
  return (
    <nav className="fixed top-0 w-full z-50 ">
      ...
      {isOpen &&
        createPortal(
          <div className="fixed inset-0 z-[9999] bg-[#ff9704] text-white w-[300px] h-full shadow-lg right-0">
            <div className="flex justify-between items-center p-4  border-b border-gray-700">
              <img src="https://rubycommercialcentre.com/images/logoicon.png" alt="Logo" className="w-[80px]" />
